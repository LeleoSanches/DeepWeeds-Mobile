...
class utils(object):
    ...
    def plot_training_curves(
        history, out_png="curvas_treinamento.png", title="Treinamento"
    ):
    ...
    def plot_confusion_and_report(
        ...
        val_generator,
        class_indices,
        cm_png="matriz_confusao.png",
        report_txt="relatorio_classificacao.txt",
        normalize=True,
    ):
    ...
    @staticmethod
    def plot_history_joined(
        hist_joined_dict,
        out_png="curvas_joined.png",
